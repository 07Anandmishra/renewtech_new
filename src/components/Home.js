...
import img1 from '../assets/Boiler.jpg'
import img2 from '../assets/boileropt-plant.jpg'
     ...
     <div className='row  pb-3'>
       <div className='col-lg-7 col-md-7 col-12 content-part'>
         ...
         <div className='logo-pictures mt-3'>
          ...
          <h5 className='mt-3'>Renewatech Engineering Services Pvt. Ltd.</h5>
    ...
    <div className='container my-5'>
     <div className='row '>
      ...
      <div className='col-lg-6 col-md-6 col-12 '>
       <h5>About Us</h5>
       <h3>Renewatech Engineering Services Pvt Ltd</h3>
