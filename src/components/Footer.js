  ...
  return (
    <>
      <footer className="text-center footer text-lg-start  text-white">
          ...
          <div className="container  text-center text-md-start mt-5">
            <div className="row mt-3">
              ...
              {/* <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 footer-section">
                <h6 className="text-uppercase fw-bold mb-3">Address 1</h6>
                <hr />
                ...
                <p className="cursor-pointer">
                  ...
                  <span>
                    {" "}
                    Indian Institute of Technology Kanpur Outreach Center, C Block, Sector 62, Gautam Buddh Nagar, Noida, Uttar Pradesh 201309
                  </span>
                </p>
             
                <p>
                  <a
                    href="https://www.google.com/maps/place/Indian+Institute+of+Technology+Kanpur+Outreach+Center/@28.613581,77.3551504,17z/data=!3m1!4b1!4m6!3m5!1s0x390ce56a82e3a2d5:0x889c998c126ad68c!8m2!3d28.613581!4d77.3577253!16s%2Fg%2F12lv3jp1j?entry=ttu"
                    target="_blank"
                  >
                    <img
                      src={gmap}
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 footer-section">
                ...
                <p className="cursor-pointer">
                  ...
                  <span>
                    {" "}
                    B-367,First Floor Chittaranjan Park, New Delhi-110019, India
                  </span>
                </p>
        ...
        "© 2024 - Renewatech Engineering Service Pvt Ltd - India”
        </div>
      </footer>
    </>
  );
